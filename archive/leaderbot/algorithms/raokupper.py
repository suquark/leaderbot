...
class RaoKupper(BaseModel):
    """
    Paired comparison based on Rao-Kupper model.
    ...
    .. code-block:: python
        ...
        >>> from leaderbot.algorithms import RaoKupper
    ...
    def __init__(
        ...
        self.n_weights = self.n_models + 1
    ...
    def _sample_loss(
        ...
        if return_jac:
            grad_win = (win_ij + tie_ij) * (1.0 - p_win)
