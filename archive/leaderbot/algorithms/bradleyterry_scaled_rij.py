...
__all__ = ['BradleyTerryScaledRIJ']


# =======================
# Bradleyterry Scaled RIJ
# =======================

class BradleyTerryScaledRIJ(BaseModel):
    """
    ...
    .. code-block:: python
        ...
        >>> from leaderbot.algorithms import BradleyTerryScaledRIJ

        >>> # Create a model
        >>> data = load_data()
        >>> alg = BradleyTerryScaledRIJ(data)
    ...
    def __init__(
        ...
        self.n_weights = 2 * self.n_models + n_pairs
    ...
    def _sample_loss(
        ...
        if return_jac:
            ...
            grads = grad_xi, grad_xj, grad_ti, grad_tj, grad_rij
    ...
    def loss(
        ...
        if return_jac:
            ...
            jac[ax, k + self.n_models * 2] += grad_rij
