...
@numba.jit(nopython=True)
def bt_loss(xi, xj, ti, tj, r, win_ij, loss_ij, tie_ij):
    s_r = np.tanh(r)
    ...
    return loss, grad_xi, grad_xj, grad_ti, grad_tj, grad_r
...
def bt_jac(w, x, y, n_models):
    ...
    loss, grad_xi, grad_xj, grad_ti, grad_tj, grad_r = bt_loss(xi, xj, ti, tj, r, win_count, loss_count, tie_count)
