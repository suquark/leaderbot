...
@numba.jit(nopython=True)
def raokupper_loss(xi, xj, ti, tj, eta, win_ij, loss_ij, tie_ij):
    ...
    return loss, grad_xi, grad_xj, grad_ti, grad_tj, grad_eta
...
def raokupper_jac(w, x, y, n_models):
    ...
    loss, grad_xi, grad_xj, grad_ti, grad_tj, grad_eta = raokupper_loss(xi, xj, ti, tj, eta, win_count, loss_count,
                                                                        tie_count)
