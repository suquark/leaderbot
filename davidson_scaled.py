...
@numba.jit(nopython=True)
def davidson_loss(xi, xj, ti, tj, mu, win_ij, loss_ij, tie_ij):
    ...
    return loss, grad_xi, grad_xj, grad_ti, grad_tj, grad_mu
...
def davidson_jac(w, x, y, n_models):
    ...
    loss, grad_xi, grad_xj, grad_ti, grad_tj, grad_mu = davidson_loss(xi, xj, ti, tj, mu, win_count, loss_count,
                                                                      tie_count)
