...
class DavidsonNoCov(BaseModel):
    """
    Paired comparison based on Davidson model.
    ...
    def _sample_loss(
        ...
        if return_jac:
            ...
            grads = (grad_xi, grad_xj, grad_mu, grad_gi, grad_gj)
    ...
    def loss(
        ...
        if return_jac:
            grad_xi, grad_xj, grad_mu, grad_gi, grad_gj = grads
            i, j = self.x.T
